...
class TokenTransactionForm(ModelForm):
	...
	amount = forms.CharField(label="", min_length=10, max_length=10, widget=forms.TextInput(attrs={'class':'form-control', 'placeholder':'Amount'}), help_text='<span class="form-text text-muted"><small>Amount must be number and positive.</small></span>')
